...
int mainQ(int in , int up , int down , int uk_0 , int uk_1 ) 
{ 
  int bias ;
  int r ;
  int __cil_tmp6 ;
...
{ 
  ...
  klee_assume(-1 <= uk_1);
  klee_assume(uk_1 <= 1);
  __cil_tmp10 = mainQ(1, 98, 200, uk_0, uk_1);
  __cil_tmp11 = mainQ(1, 150, 200, uk_0, uk_1);
  if (__cil_tmp10 == 0 && __cil_tmp11 == 1) {
