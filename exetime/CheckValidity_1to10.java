...
public class CheckValidity_1to10 {
	public String vf;
	public String prefix;
	public String ts;
	String outf;
	public CheckValidity_1to10(String a,String b,String d,String c)
	{
		this.vf=a;
		this.prefix=b;
		this.ts=d;
	...
	public void check() throws IOException
	{
		...
		while((line=br.readLine())!=null)
		{
			...
			else if(line.contains("----------test"))
			{
				...
				seed=line.substring(p+5,line.length());
			}
			else if(line.contains("valid"))
			{
				if(line.startsWith("valid"))
				{
					one=this.prefix+"/"+prog+"/"+this.ts+"/1repairs/"+version+"/repair.debug.*-"+seed;
					bw.write(one);bw.newLine();
				}
				else
				{
					System.out.println(version+":seed"+seed);
				}
			}
    ...
    {
    	CheckValidity_1to10 ct=new CheckValidity_1to10(args[0],args[1],args[2],args[3]);
    	ct.check();
    }
}
